  ...
  return (
    <footer className="bg-gray-100 py-12">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <p className="text-xs text-slate-500 text-center mb-4 max-w-2xl mx-auto leading-relaxed opacity-70">
          {t(TRANSLATIONS.footer.disclaimer)}
        </p>
        <div className="flex items-center justify-center gap-6 text-xs font-medium tracking-wide">
          <span className="text-slate-600">
            {t(TRANSLATIONS.footer.builtBy)}
          </span>
